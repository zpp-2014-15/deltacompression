...
Dla pierwszej wersji jest to 0.05\%, wiêc bardzo ma³o.
Jest to spowodowane tym, ¿e dane siê nie powtarzaj¹.
Prawie wszystkie dane, które system otrzyma³ by³y zupe³nie nowe.
...
Jest to niewiele lepszy wynik.

Przeanalizujmy najpierw metody oznaczone kolorami: czerwonym, zielonym i ¿ó³tym.
Wszystkie trzy nie u¿ywaj¹ indeksu podobieñstwa, ró¿ni¹ siê jedynie typem kompresji u¿ytym przed wys³aniem danych.
...
Dla pierwszej wersji wyniki braku delta kodowania z ró¿nymi typami kompresji (kolory czerwony, zielony, ¿ó³ty) prawie idealnie odpowiadaj¹ metodzie z u¿yciem indeksu podobieñstwa (kolory b³êkitny, fioletowy, szary).
...
Odpowiednio dla standardowej metody i kompresji LZO jest to 57MB, a dla indeksu podobieñstwa 26MB.
...
ród³a django zajmuj¹ kilkadziesi¹t MB i dlatego by³o mo¿liwe przetestowanie optymalnego algorytmu delta kodowania.
