...
Stworzony symulator umo¿liwia szybkie sprawdzanie efektywnoœci algorytmów delta kodowania na ró¿nych danych wejœciowych.
...
\begin{description}
        ...
        Zosta³y zaimplementowane: replikacja bez delta kodowania, algorytm optymalny oraz algorytm z indeksem podobieñstwa.
	...
	Po zastosowaniu odpowiedniego algorytmu delta kodowania dane przed wys³aniem mog¹ byæ dodatkowo kompresowane przy pomocy LZO, ZIP lub LZMA.
...
Natomiast sposób, w jaki kontroler dostaje informacje o zmianie modeli jest zró¿nicowany.
...
\section{Chunker}
Chunker jest modu³em umo¿liwiaj¹cym czytanie plików z danymi jako strumieñ bajtów i dzieleniem go na bloki.
Zawiera adapter w Pythonie do napisanej w C++ biblioteki statycznej pochodz¹cej z systemu HYDRAstor.
