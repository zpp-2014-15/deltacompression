...
Tylko wtedy mo¿na oczekiwaæ, ¿e uzyskane rezultaty s¹ dobr¹ aproksymacj¹ wyników w œrodowisku produkcyjnym.
...
Wysokoœæ s³upka okreœla, ile danych trzeba przes³aæ dla danej wersji danych przy u¿yciu danej metody.
...
Zacznijmy od iloœci duplikatów.
...
To mo¿e t³umaczyæ, dlaczego indeks podobieñstwa nie daje praktycznie ¿adnego zysku.
...
Dziêki temu mogliœmy porównaæ indeks podobieñstwa z optymalnym delta kodowaniem.
...
Zmiany w kolejnych wersjach nie by³y wiêc du¿e.
...
Warto wiêc próbowaæ optymalizowaæ indeks podobieñstwa.
...
Poza tym u¿ywaliœmy innego Chunkera.
...
Dlatego decyzji o ewentualnym zastosowaniu delta kodowania powinna towarzyszyæ dok³adna analiza danych produkcyjnych.
...
Przy niewielkich nak³adach pracy mo¿na uzyskaæ dobre rezultaty stosuj¹c kompresjê LZMA na wiêkszych kawa³kach danych.
