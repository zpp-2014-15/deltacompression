...
Sposób organizacji pracy zespo³u ma du¿y wp³yw na jakoœæ efektu koñcowego i terminowoœæ, dlatego jego wybór nie powinien byæ przypadkowy.
...
Kolejnym powodem by³a zapowiedŸ firmy 9LivesData, ¿e wymagania mog¹ siê zmieniaæ w zale¿noœci od osi¹ganych rezulatów.
...
Nastêpnie realizowaliœmy zadania pojedynczej iteracji zgodnie z za³o¿eniami Kanbana, co opiszemy póŸniej.
...
\begin{enumerate}
    ...
    \item \label{item:merge}Programista w³¹cza kod do g³ównej ga³êzi projektu.
\end{enumerate}
