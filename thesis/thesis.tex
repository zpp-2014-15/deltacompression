...
Wybraliœmy go, gdy¿ jest on jêzykiem wysokiego poziomu i bardzo szybko siê w nim pisze.
Jednoczeœnie jest w nim dostêpnych mnóstwo najró¿niejszych bibliotek, z których czêsto korzystaliœmy w naszym projekcie.
...
\subsection{pylint}
Narzêdzie do statycznej analizy kodu.
Sprawdza zgodnoœæ z zaleceniami PEP 8.
Znacznie u³atwia ono dbanie o jakoœæ Ÿróde³.
\subsection{pylzma}
