...
Dyski komputerów na ca³ym œwiecie przchowuj¹ tysi¹ce terabajtów danych. 
...
S¹ one wykonywane w obrêbie jednego centrum danych.
Mo¿na jednak zapewniæ wiêksz¹ odpornoœæ na b³êdy.
Wystarczy wykonaæ replikê w innym centrum danych.
Jednak du¿ym problemem tego rozwi¹zania jest wydajnoœæ ³¹cza internetowego.
...
Niestety zaimplementowanie nowego rozwi¹zania w istniej¹cym systemie wymaga du¿ego nak³adu pracy.
