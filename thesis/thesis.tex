...
\begin{figure}[h]
    ...
    \begin{minipage}[t]{0.45\textwidth}
        ...
        \captionof{figure}{Z systemu A chcemy przes³aæ do systemu B dane.}
        \label{fig:hydra1}
    \end{minipage}
    \hspace{\fill}
    \begin{minipage}[t]{0.45\textwidth}
        ...
        \captionof{figure}{System A dzieli dane na bloki, dla ka¿dego z bloków liczy wartoœæ funkcji skrótu. Dla identycznych bloków dostajemy takie same wartoœci.}
        \label{fig:hydra2}
    \end{minipage}
\end{figure}
...
\begin{figure}[h]
    ...
    \begin{minipage}[t]{0.45\textwidth}
        ...
        \captionof{figure}{System A przesy³a do systemu B informacje o po³o¿eniu kolejnych bloków (tj. ci¹g identyfikatorów) oraz zawartoœci bloków z pominiêciem duplikatów (deduplikacja).}
        \label{fig:hydra3}
    \end{minipage}
    \hspace{\fill}
    \begin{minipage}[t]{0.45\textwidth}
