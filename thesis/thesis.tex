...
W celu przes³ania kopii zapasowej na zdalny serwer niezbêdne dane s¹ kompresowane i przesy³ane przez Internet (replikacja).
\begin{figure}[h]
    \centering
...
Za dzielenie danych na bloki odpowiada komponent zwany Chunkerem.
...
Gdy ró¿nice miêdzy blokami s¹ ma³e, delta kodowania potrafi znacznie zmniejszyæ rozmiar przesy³anych danych.
Na wielkoœæ ró¿nic wp³yw ma to, które dane s¹ ze sob¹ porównywane oraz jaki algorytm liczenia ró¿nic zosta³ u¿yty.
