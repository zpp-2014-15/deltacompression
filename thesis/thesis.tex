...
\begin{description}
	...
	Symulator umo¿liwia liczenie, ile odczytów i zapisów do Storage'u wykona³ na danej wersji ka¿dy z algorytmów delta kodowania.
...
Natomiast sposób, w jaki kontroler dostaje informacje o zmianie modeli jest zale¿ny od konkretnego modelu.
...
\section{Chunker}
Chunker jest modu³em zajmuj¹cym siê zamienianiem katalogów z wersjami danych na strumieñ i dzieleniem go na bloki.
