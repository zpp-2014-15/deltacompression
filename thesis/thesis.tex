...
\begin{figure}[H]
    ...
    \begin{minipage}[t]{0.45\textwidth}
        ...
        \captionof{figure}{System A dzieli dane na bloki i dla ka¿dego z bloków liczy wartoœæ funkcji skrótu. W tym momencie s¹ ju¿ wykrywane duplikaty - blok H1 wytêpuje dwa razy.}
        \label{fig:hydra2}
    \end{minipage}
\end{figure}
...
We wczeœniejszym przyk³adzie z dodaniem jednego znaku Chunker wyznaczy³by granice tak, ¿e kilka bloków po nowym znaku by³oby innych, ale reszta nie zmieni³aby siê.
...
Dedublipacja oraz bloki zmiennej d³ugoœci znacznie przyspieszaj¹ replikacjê w systemie HYDRAstor.
...
W powy¿szym przyk³adzie (\ref{fig:hydra6}) zmiana danych by³a bardzo ma³a.
