...
W minimalizacji ich rozmiaru niew¹tpliwie pomaga dzielenie strumienia danych na bloki zmiennej d³ugoœci i wykorzystywanie funkcji skrótu do eliminacji duplikatów.
...
Widaæ zatem, ¿e w systemie HYDRAstor warto rozwa¿yæ u¿ycie znacznie bardziej kosztownego obliczeniowo algorytmu LZMA.
...
Jeszcze gorzej prezentuje siê porównanie tych metod gdy u¿ywamy algorytmu LZMA (kolory ¿ó³ty i szary).
...
Poza tym, nie mieliœmy dostêpu do wiêkszych danych, a tak¿e do sprzêtu o wiêkszej iloœci pamiêci RAM i lepszej mocy obliczeniowej.
