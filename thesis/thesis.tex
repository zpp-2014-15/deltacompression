...
Oto lista najwa¿niejszych funkcjonalnoœci symulatora:
\begin{itemize}
        \item
        ...
        \item
        Mo¿liwoœæ wyboru algorytmu delta kodowania.
        
        Zosta³y zaimplementowane: replikacja bez delta kodowania, algorytm optymalny oraz algorytm z indeksem podobieñstwa.
	Symulator pozwala na przetestowanie tych algorytmów oraz udostêpnia intuicyjny interfejs programistyczny, dziêki czemu mo¿na w prosty sposób dodawaæ kolejne algorytmy.
        \item
	...
	\item
	Asynchroniczna kolejka eksperymentów.
	...
	Wyniki wykonanych eksperymentów mo¿na wyœwietliæ w sposób czytelny i atrakcyjny wizualnie w postaci interaktywnych wykresów.
	\item
